...
public class SpringDepreciationController {

    private final SpringDepreciationService depreciationService;

    public SpringDepreciationController(SpringDepreciationService depreciationService) {
    ...
    public ResponseEntity<SpringDepreciationService.DepreciationCalculation> calculateDepreciation(
            @PathVariable Long id,
            @RequestParam LocalDate calculationDate) {
        try {
            SpringDepreciationService.DepreciationCalculation calculation =
    ...
    public ResponseEntity<SpringDepreciationService.DepreciationProcessingResult> processDepreciation(
            @PathVariable Long companyId,
            @RequestParam LocalDate processingDate,
            @RequestParam Long fiscalPeriodId) {
        try {
            SpringDepreciationService.DepreciationProcessingResult result =
    ...
    public ResponseEntity<SpringDepreciationService.DepreciationSummary> getDepreciationSummary(
            @PathVariable Long companyId,
            @PathVariable Long fiscalPeriodId) {
        try {
            SpringDepreciationService.DepreciationSummary summary =
    ...
    public ResponseEntity<BigDecimal> calculateStraightLineDepreciation(
        ...
        try {
            BigDecimal depreciation = SpringDepreciationService.calculateStraightLineDepreciation(
