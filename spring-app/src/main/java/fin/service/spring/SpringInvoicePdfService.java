 ...
 */
@Service
public class SpringInvoicePdfService {
    ...
    public SpringInvoicePdfService(ManualInvoiceRepository manualInvoiceRepository,
    ...
    public byte[] generateInvoicePdfBytes(Long invoiceId, Company company, FiscalPeriod fiscalPeriod) throws SQLException, IOException {
        debugger.logMethodEntry("SpringInvoicePdfService", "generateInvoicePdfBytes", invoiceId, company.getId(), fiscalPeriod.getId());

        // Fetch invoice data from database
        InvoiceData invoiceData = fetchInvoiceData(invoiceId);

        if (invoiceData == null) {
            debugger.logValidationError("SpringInvoicePdfService", "generateInvoicePdfBytes", "invoiceId", invoiceId.toString(), "Invoice not found");
        ...
        debugger.logMethodExit("SpringInvoicePdfService", "generateInvoicePdfBytes", "PDF generated successfully");
        return pdfBytes;
    }
