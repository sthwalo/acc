 ...
 * Commercial use of the Apache License 2.0.
...
import fin.api.controllers.UploadController;
...
public class UploadRoutes {
     ...
     * @param uploadController the upload controller
     * @param authMiddleware the auth middleware
     */
    public static void register(Gson gson, UploadController uploadController, AuthMiddleware authMiddleware) {
