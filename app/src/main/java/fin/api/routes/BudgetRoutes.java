...
import fin.api.controllers.BudgetController;
...
public class BudgetRoutes {
     ...
     * @param budgetController the budget controller
     * @param authMiddleware the auth middleware
     */
    public static void register(Gson gson, BudgetController budgetController, AuthMiddleware authMiddleware) {
