...
public class SpringExportController {

    private final SpringCsvExportService csvExportService;
    private final SpringPdfExportService pdfExportService;
    ...
    public SpringExportController(SpringCsvExportService csvExportService,
                                SpringPdfExportService pdfExportService,
