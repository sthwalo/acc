...
public class BudgetController {
    ...
    public ResponseEntity<BudgetService.BudgetVariance> getBudgetVariance(@PathVariable Long id) {
        try {
            BudgetService.BudgetVariance variance = budgetService.getBudgetVariance(id);
    ...
    public ResponseEntity<BudgetService.BudgetSummary> getBudgetSummary(@PathVariable Long companyId,
                                                                            @PathVariable Long fiscalPeriodId) {
        try {
            BudgetService.BudgetSummary summary = budgetService.getBudgetSummary(companyId, fiscalPeriodId);
